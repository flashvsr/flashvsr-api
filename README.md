...
[![Python 3.8+](https://img.shields.io/badge/python-3.8%2B-blue.svg)](https://www.python.org/) [![License: MIT](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE) [![Hosted on Synexa](https://img.shields.io/badge/hosted%20on-Synexa-6366f1.svg)](https://synexa.ai/explore/bytedance/seedvr2-upscale?utm_source=github&utm_medium=ugc&utm_campaign=flashvsr&utm_content=readme-badge&utm_term=tier-a)
...
> **Try it now:** [https://synexa.ai/explore/bytedance/seedvr2-upscale](https://synexa.ai/explore/bytedance/seedvr2-upscale?utm_source=github&utm_medium=ugc&utm_campaign=flashvsr&utm_content=readme-top&utm_term=tier-a) — the hosted model behind this client. New accounts get a free trial credit.
...
Then set your API key (create one at [synexa.ai](https://synexa.ai?utm_source=github&utm_medium=ugc&utm_campaign=flashvsr&utm_content=readme-apikey&utm_term=tier-a)):
...
|---|---|---|---|
| [`bytedance/seedvr2-upscale`](https://synexa.ai/explore/bytedance/seedvr2-upscale?utm_source=github&utm_medium=ugc&utm_campaign=flashvsr&utm_content=readme-models&utm_term=tier-a) | super-resolution | SeedVR2 restores and upscales images, recovering detail rather than simply interpolating pixels. | $0.004 |
